...
const classes = [
  ...
  },
  {
    ...
    instructor: { name: 'Theater Director David', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', rating: 4.9 },
    category: 'acting',
    location: 'Miami Theater Studio',
    distance: '2.3 mi',
    price: 85,
    duration: '2 hours',
  ...
  {
    id: '14',
    title: 'Pilates Core Strength & Flexibility',
    instructor: { name: 'Pilates Master Lisa', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150', rating: 4.8 },
    category: 'pilates',
    location: 'Equinox South Beach',
    distance: '1.5 mi',
    price: 50,
    duration: '1 hour',
  ...
  {
    id: '15',
    title: 'French Pastry & Baking Masterclass',
    instructor: { name: 'Chef Marie', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', rating: 5.0 },
    category: 'baking',
    location: 'Miami Culinary Institute',
    distance: '3.2 mi',
    price: 120,
    duration: '3 hours',
    image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=400',
  ...
  },
  {
    ...
    instructor: { name: 'Instructor Sophia', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', rating: 4.7 },
    category: 'pilates',
    location: 'Equinox South Beach',
    distance: '1.5 mi',
    price: 45,
  ...
  },
  {
    ...
    instructor: { name: 'Communication Coach James', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150', rating: 4.9 },
    category: 'diction',
    location: 'Online',
    distance: 'Online',
    price: 55,
  ...
  {
    id: '18',
    title: 'Theater Audition Techniques',
    instructor: { name: 'Casting Director Mike', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', rating: 4.8 },
    category: 'acting',
    location: 'Miami Theater Studio',
    distance: '2.3 mi',
    price: 90,
    ...
    nextAvailable: 'Sun, 3 PM',
    students: 28,
    hasCertificate: false,
  },
  {
    id: '19',
    title: 'Artisan Bread & Pastry Making',
    instructor: { name: 'Master Baker Emma', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150', rating: 5.0 },
    category: 'baking',
    location: 'Miami Culinary Institute',
    distance: '3.2 mi',
    price: 110,
